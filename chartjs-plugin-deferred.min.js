...
!function(e, t) {
    ...
    function n(e) {
        for (var t, n = e.chart.canvas.parentElement; n; )
            ...
            }(n) || (0 === (t = (t = n[a] || (n[a] = {})).charts || (t.charts = [])).length && r.addEvent(n, "scroll", l),
            t.push(e),
            e[i].elements.push(n)),
    ...
    function s(n) {
        n[i].elements.forEach(function(e) {
            ...
            t.length || (r.removeEvent(e, "scroll", l),
            delete e[a])
        }),
        n[i].elements = []
    }
    /*
    e.defaults.global.plugins.deferred = {
        xOffset: 0,
        yOffset: 0,
        delay: 0
    },

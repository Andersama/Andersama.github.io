...
|                0.11 |    8,936,764,258.15 |    3.2% |     11.83 | &#96;byte cmp&#96;</code>`,!0),n(p);var c=s(p,8);a(c,()=>`<code class="language-undefined">|               ns/op |                op/s |    err% |     total | benchmark
|--------------------:|--------------------:|--------:|----------:|:----------
|                0.10 |    9,643,190,854.87 |    0.0% |      0.00 | &#96;memcmp&#96;
|                0.10 |    9,644,749,316.32 |    0.0% |      0.00 | &#96;byte cmp&#96;</code>`,!0),n(c);var i=s(c,4);a(i,()=>`<code class="language-undefined">|               ns/op |                op/s |    err% |     total | benchmark
|--------------------:|--------------------:|--------:|----------:|:----------
...
|                0.10 |    9,646,511,627.91 |    0.0% |      0.00 | &#96;byte cmp (64)&#96;</code>`,!0),n(i);var r=s(i,6);a(r,()=>`<code class="language-c">constexpr <span class="token keyword">auto</span> <span class="token function">byte_cmp</span><span class="token punctuation">(</span><span class="token keyword">const</span> <span class="token keyword">char</span><span class="token operator">*</span> pattern<span class="token punctuation">,</span> <span class="token keyword">const</span> <span class="token keyword">char</span><span class="token operator">*</span> input<span class="token punctuation">,</span> <span class="token class-name">size_t</span> sz<span class="token punctuation">)</span> noexcept <span class="token punctuation">&#123;</span>
	...
	<span class="token keyword">return</span> ret<span class="token punctuation">;</span>
<span class="token punctuation">&#125;</span></code>`,!0),n(r);var l=s(r,6);a(l,()=>`<code class="language-undefined">|               ns/op |                op/s |    err% |     total | benchmark
|--------------------:|--------------------:|--------:|----------:|:----------
...
|                0.12 |    8,624,424,732.14 |    2.4% |     12.25 | &#96;byte cmp (64)&#96;</code>`,!0),n(l);var u=s(l,10);a(u,()=>`<code class="language-c">    bench<span class="token punctuation">.</span><span class="token function">run</span><span class="token punctuation">(</span><span class="token string">"memcmp"</span><span class="token punctuation">,</span> <span class="token punctuation">[</span><span class="token operator">&amp;</span>count<span class="token punctuation">]</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
|                0.15 |    6,867,877,477.58 |    4.3% |     11.93 | &#96;byte cmp&#96;</code>`,!0),n(k);var m=s(k,6);a(m,()=>`<code class="language-undefined">|               ns/op |                op/s |    err% |     total | benchmark
|--------------------:|--------------------:|--------:|----------:|:----------
...
|                0.25 |    3,999,846,415.60 |    5.4% |     11.52 | :wavy_dash: &#96;byte eq (!=)&#96; (Unstable with ~246,409,890.3 iters. Increase &#96;minEpochIterations&#96; to e.g. 2464098903)</code>`,!0),n(w);var d=s(w,8);a(d,()=>`<code class="language-undefined">|               ns/op |                op/s |    err% |     total | benchmark
|--------------------:|--------------------:|--------:|----------:|:----------
...
|                0.66 |    1,524,836,223.99 |    8.6% |     11.99 | :wavy_dash: &#96;byte eq (unroll branch)&#96; (Unstable with ~98,337,616.8 iters. Increase &#96;minEpochIterations&#96; to e.g. 983376168)</code>`,!0),n(I);var _=s(I,4);a(_,()=>`<code class="language-c"><span class="token keyword">int</span> <span class="token function">byte_eq_sse_negated</span><span class="token punctuation">(</span><span class="token keyword">const</span> <span class="token keyword">char</span><span class="token operator">*</span> pattern<span class="token punctuation">,</span> <span class="token keyword">const</span> <span class="token keyword">char</span><span class="token operator">*</span> input<span class="token punctuation">,</span> <span class="token class-name">size_t</span> sz<span class="token punctuation">)</span> noexcept <span class="token punctuation">&#123;</span>
...
|                0.64 |    1,570,911,526.41 |    2.3% |     12.18 | &#96;byte eq (sse negated)&#96;</code>`,!0),n(f),W(8),E(U,v)}export{D as default,A as metadata};
